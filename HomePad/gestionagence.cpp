...
QString filename="C:/Users/amirb/Desktop/project/HomePad/cartevisite/cartevisite.pdf"; //cree un fichier dans ce path
QPdfWriter pdfwriter(filename);
pdfwriter.setPageSize(QPageSize(QPageSize::A4));
QPainter painter(&pdfwriter); //varriable necessaire pour ecrire dans pdf

//***** ecrire dans le pdf *****
QImage cartevisitetemplate("C:/Users/amirb/Desktop/project/HomePad/cartevistetemplate.png");
