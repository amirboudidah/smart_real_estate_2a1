...
QString imageqr = "C:/Users/amirb/Desktop/project/HomePad/qrcodes/qrcode_"+numcontrat+".png";
QString filename1="C:/Users/amirb/Desktop/project/HomePad/Contrat_"+numcontrat+".docx";
QFile file( filename1 );
QTextStream stream( &file );
file.open(QIODevice::ReadWrite);
stream << contenu << endl;
QFile inputFile(filename1);
QString filename="C:/Users/amirb/Desktop/project/HomePad/contrats/Contrat_"+numcontrat+".pdf";
...
QImage logo("C:/Users/amirb/Desktop/project/HomePad/logo.png");
...
void gestioncontrats::writeqrcode(QString code,QString id)
{
                   ...
                   QString file="C:/Users/amirb/Desktop/project/HomePad/qrcodes/qrcode_"+id+".svg";
                   std::ofstream myfile;
                   myfile.open(file.toStdString());
                   myfile << qr.toSvgString(1);
                   myfile.close();
                   QSvgRenderer svgRenderer(QString("C:/Users/amirb/Desktop/project/HomePad/qrcodes/qrcode_"+id+".svg"));
                   QPixmap pix( QSize(1000, 1000) );
                   QPainter pixPainter( &pix );
                   svgRenderer.render( &pixPainter );
                   // Load your SVG
                   QSvgRenderer renderer(QString("C:/Users/amirb/Desktop/project/HomePad/qrcodes/qrcode_"+id+".svg"));
                   ...
                   image.save("C:/Users/amirb/Desktop/project/HomePad/qrcodes/qrcode_"+id+".png");
                   QFile F(file);
                   F.remove();
}
...
//        if(file.isFile()==true)
//        {
        MimeAttachment document(new QFile("C:/Users/amirb/Desktop/project/HomePad/contrats/Contrat_"+id+".pdf"));
