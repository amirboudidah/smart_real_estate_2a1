...
void immobilier::on_ajoutprod_clicked()
{
...
void immobilier::on_suppprod_clicked()
{
    Produits p1;
...
void immobilier::on_Modifprod_clicked()
{
    Modifier m;
...
void immobilier::on_triprod_currentIndexChanged(int index)
{
    QString prod;
    Produits p1;
    if (index == 0)
...
void immobilier::on_pdfprod_clicked()
{
    QString strStream;
...
void immobilier::on_inserimageprod_clicked()
{
...
void immobilier::on_rechercheprod_cursorPositionChanged(int arg1, int arg2)
{
    Produits p1;
