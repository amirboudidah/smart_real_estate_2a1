...
QString filename="C:/Users/amirb/Desktop/HomePad-Copie/cartevisite/cartevisite.pdf"; //cree un fichier dans ce path
QPdfWriter pdfwriter(filename);
pdfwriter.setPageSize(QPageSize(QPageSize::A4));
pdfwriter.setPageOrientation(QPageLayout::Landscape);
QPainter painter(&pdfwriter); //varriable necessaire pour ecrire dans pdf
//***** ecrire dans le pdf *****
QImage cartevisitetemplate("C:/Users/amirb/Desktop/HomePad-Copie/cartevistetemplate.png");
painter.setFont(QFont("times",9));
painter.drawImage(4500,0,cartevisitetemplate);//dans pdf
painter.drawText(5850,5500,adresse);
painter.drawText(5850,4900,numtel);
painter.drawText(6200,3950,nomgerant);
painter.drawText(6200,4150,prenomgerant);
...
QSqlQueryModel * GestionAgence::rechercheemployea(QString r)
{
    QSqlQueryModel * model=new QSqlQueryModel();
    model->setQuery("select * from employes where ide="+r);
    model->setHeaderData(0,Qt::Horizontal,QObject::tr("numAgence"));
    model->setHeaderData(1,Qt::Horizontal,QObject::tr("nomAgence"));
    model->setHeaderData(2,Qt::Horizontal,QObject::tr("ville"));
    model->setHeaderData(3,Qt::Horizontal,QObject::tr("numtelA"));
