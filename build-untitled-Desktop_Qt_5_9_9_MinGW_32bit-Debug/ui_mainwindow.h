...
"color: rgb(0, 0, 0);"));
        ...
        lineEdit_ut = new QLineEdit(centralwidget);
        lineEdit_ut->setObjectName(QStringLiteral("lineEdit_ut"));
        lineEdit_ut->setGeometry(QRect(560, 190, 201, 35));
        lineEdit_ut->setStyleSheet(QStringLiteral("border-radius: 10px;"));
        ...
        lineEdit_mdp->setGeometry(QRect(560, 250, 201, 35));
        lineEdit_mdp->setStyleSheet(QStringLiteral("border-radius: 10px;"));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        lineEdit_ut->setPlaceholderText(QApplication::translate("MainWindow", "Nom d'utilisateur", Q_NULLPTR));
